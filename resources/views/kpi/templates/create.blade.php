...
@section('title', 'Create New KPI Template')
@section('header_icon', 'icon-park-outline--add')
@section('content_header', 'Create New KPI Template')
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control @error('template_name') is-invalid @enderror" id="template_name" name="template_name" value="{{ old('template_name') }}" required placeholder="Enter Template Name">
                                    @error('template_name')
