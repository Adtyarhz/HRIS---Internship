                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="{{ route('kpi-templates.show', $template->id) }}" class="btn-info"
                                                    title="Manage Items">
                                                ...
                                                <x-delete-modal modalId="kpi-template-{{ $template->id }}"
                                                    :action="route('kpi-templates.destroy', [$template->id])"
