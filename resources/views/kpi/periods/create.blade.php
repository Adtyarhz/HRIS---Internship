                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @enderror
                                        <small class="form-text text-muted">Enter a descriptive name for the custom
                                            period.</small>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <select name="status" id="status"
                                            ...
                                            <option value="Aktif" {{ old('status') == 'Aktif' ? 'selected' : '' }}>Active
                                            </option>
                                            <option value="Ditutup" {{ old('status') == 'Ditutup' ? 'selected' : '' }}>Closed
                                            </option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback d-block">{{ $message }}</span>
