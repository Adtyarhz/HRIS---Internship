    ...
    <script>
        function drawChart() {
            ...
            descendants.forEach(n => {
                n.y = n.data.depth * (nodeHeight + verticalSpacing);
            });
            ...
            const viewBoxWidth = (xMax - xMin) + nodeWidth + margin.left + margin.right;
            const viewBoxHeight = (yMax - yMin) + nodeHeight + margin.top + margin.bottom;
            ...
            // --- Draw Main Links with Shared Horizontal Bar ---
            ...
            // --- Draw Indirect Links with Collision Avoidance ---
            const laneManager = {
                lanes: {},
            ...
            g.selectAll(".indirect-link")
                .data(chartData.indirectLinks || [])
                .enter().append("path").attr("class", "indirect-link")
                .attr("d", d => {
