...
@section('content')
    @include('recruitment.partials.tab-menu-recruitment')
    <!-- Tab Content: Manage Applicants -->
    <div id="manage-applicants" class="tab-content {{ request()->routeIs('applicants.index*') ? 'active' : '' }}">
