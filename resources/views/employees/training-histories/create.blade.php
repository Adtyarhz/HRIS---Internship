                ...
                <form action="{{ route('employees.training-histories.store', $employee->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                        rows="6" placeholder="Brief description of the training program">{{ old('description') }}</textarea>
                                    @error('description')
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-3">
                                    <input type="text"
                                        ...
                                        value="{{ old('certificate_number') }}" placeholder="e.g., TR-2025-001" required>
                            ...
                            <div class="form-group row align-items-center">
                                <label for="material_files" class="col-md-2 col-form-label">Training Record Material File :</label>
                                <div class="col-md-4">
                                    <input type="file"
                                        class="form-control @error('material_files.*') is-invalid @enderror"
                                        id="material_files" name="material_files[]" multiple>
                                    <small class="form-text text-muted">You can select more than one file if needed (PDF, JPG, PNG, DOC, DOCX, ZIP, max 10MB
