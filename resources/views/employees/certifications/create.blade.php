                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                        rows="3" placeholder="Brief description of certification">{{ old('description') }}</textarea>
                                    @error('description')
                            ...
                            <div class="form-group row align-items-center">
                                <label for="certificate_file" class="col-md-2 col-form-label">
                                    Main Certificate File <span class="text-danger">*</span> :
                                </label>
                                <div class="col-md-4">
                                    <input type="file"
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small class="form-text text-muted">
                                        You can select more than one file if needed (PDF, JPG, PNG, DOC, DOCX, ZIP, max 10MB
