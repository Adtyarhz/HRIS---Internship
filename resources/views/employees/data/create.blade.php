                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('full_name') is-invalid @enderror" id="full_name" name="full_name" placeholder="Enter full name" value="{{ old('full_name') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik" name="nik" placeholder="Input NIK Number" value="{{ old('nik') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('birth_place') is-invalid @enderror" id="birth_place" name="birth_place" placeholder="City" value="{{ old('birth_place') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number" placeholder="+62..." value="{{ old('phone_number') }}">
                        ...
                        <div class="col-md-6">
                             <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="employee@example.com" value="{{ old('email') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('marital_status') is-invalid @enderror" id="marital_status" name="marital_status">
                                    ...
                                    <option value="Pernikahan Pertama" {{ old('marital_status') == 'Pernikahan Pertama' ? 'selected' : '' }}>Pernikahan Pertama</option>
                                    <option value="Pernikahan Kedua" {{ old('marital_status') == 'Pernikahan Kedua' ? 'selected' : '' }}>Pernikahan Kedua</option>
                                    <option value="Pernikahan Ketiga" {{ old('marital_status') == 'Pernikahan Ketiga' ? 'selected' : '' }}>Pernikahan Ketiga</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('dependents') is-invalid @enderror" id="dependents" name="dependents" placeholder="0" value="{{ old('dependents') }}">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('ktp_address') is-invalid @enderror" id="ktp_address" name="ktp_address" rows="3" placeholder="Enter address as per ID card">{{ old('ktp_address') }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('current_address') is-invalid @enderror" id="current_address" name="current_address" rows="3" placeholder="Enter current residential address">{{ old('current_address') }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('npwp') is-invalid @enderror" id="npwp" name="npwp" placeholder="Input NPWP Number" value="{{ old('npwp') }}">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group date-input-group">
                                    <input type="date" class="form-control @error('separation_date') is-invalid @enderror" id="separation_date" name="separation_date" value="{{ old('separation_date') }}">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('employee_type') is-invalid @enderror" id="employee_type" name="employee_type">
                                    <option value="">Select Type</option>
                                    <option value="Kontrak" {{ old('employee_type') == 'Kontrak' ? 'selected' : '' }}>Kontrak</option>
                                    <option value="Magang" {{ old('employee_type') == 'Magang' ? 'selected' : '' }}>Magang</option>
                                    <option value="Masa Percobaan" {{ old('employee_type') == 'Masa Percobaan' ? 'selected' : '' }}>Masa Percobaan</option>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <img id="photo-preview" src="https://placehold.co/200x200/EFEFEF/AAAAAA?text=Photo+Preview" alt="Photo Preview" class="photo-preview mb-2">
